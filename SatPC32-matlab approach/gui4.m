...
% Last Modified by GUIDE v2.5 01-Aug-2014 18:04:19
...
function stopAllRotors_Callback(hObject, eventdata, handles)
% hObject    handle to stopAllRotors (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)


% --- Executes on button press in startFollowingSatProgram.
function startFollowingSatProgram_Callback(hObject, eventdata, handles)
% hObject    handle to startFollowingSatProgram (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of startFollowingSatProgram
